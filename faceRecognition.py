...
def faceDetection(test_img):
    ...
    face_haar_cascade=cv2.CascadeClassifier('C:/Users/Nareswara/OneDrive/Documents/PCD/UAS/FaceRecognition-master/HaarCascade/haarcascade_frontalface_default.xml')#Load haar classifier
